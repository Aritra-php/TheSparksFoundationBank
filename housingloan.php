...
$sql="SELECT rEmail FROM houseloan WHERE rEmail='".$rEmail."'";
...
{
$sql="INSERT INTO houseloan(rName,rEmail,rDOB,rDOA,rPhno,rCity,rState,rAddress,rOcc,rPinCode,rAdharno,rPanno,
rMonSalary)VALUES
...
<title>HousingLoanForm.com</title>
</head>
<body>
<div class="container">
<div class="row">
