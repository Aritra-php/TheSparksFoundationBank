...
$sql="SELECT rEmail FROM educationloan WHERE rEmail='".$rEmail."'";
...
{
$sql="INSERT INTO educationloan(rName,rEmail,rDOB,rDOA,rPhno,rCity,rState,rAddress,rOcc,rPinCode,rAdharno,rPanno,
rMonSalary)VALUES
...
<title>EducationLoanForm.com</title>
</head>
<body>
<div class="container">
<div class="row">
