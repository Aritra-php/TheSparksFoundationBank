...
$sql="SELECT rEmail FROM healthloan WHERE rEmail='".$rEmail."'";
...
{
$sql="INSERT INTO healthloan(rName,rEmail,rDOB,rDOA,rPhno,rCity,rState,rAddress,rOcc,rPinCode,rAdharno,rPanno,
rMonSalary)VALUES
...
<title>HealthLoanForm.com</title>
</head>
<body>
<div class="container">
<div class="row">
